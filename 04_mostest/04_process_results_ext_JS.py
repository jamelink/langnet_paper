...
if __name__ == '__main__':
    if len(sys.argv) <= 2:
        ...
        print(' pheno - provide file of original pheno file (CSV)')
    ...
    bim = pd.read_csv(bim_file, sep='\t', header=None, names='#CHROM SNP GP POS REF ALT'.split())
    del bim['GP']
    ...
    with h5py.File(fname + '_zmat.mat', 'r') as h5file:
        ...
        if 'freqvec' in h5file:
            ...
            for measure_index, measure in enumerate(measures):
                ...
                bim['P'] = np.transpose(pval_orig[measure_index, :])
            ...
            for measure_index, measure in enumerate(measures):
                ...
                print('Generate {}...'.format(fname))
                bim['A1'] = bim['REF']
                bim['P'] = np.transpose(pval_perm[measure_index, :])
